...
var CAccordionCollapse = defineComponent({
...
var CBreadcrumbItem = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    }, props.active && { "aria-current": "page" }), props.href ? h("a", { href: props.href }, slots.default && slots.default()) : slots.default && slots.default());
  }
});
...
var CButton = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    return () => h(props.component, __spreadProps(__spreadValues(__spreadValues(__spreadValues({
      class: [
        "btn",
    ...
    }, props.component === "a" && props.disabled && { "aria-disabled": true, tabIndex: -1 }), props.component === "a" && props.href && { href: props.href }), props.component === "button" && { type: props.type }), {
      onClick: handleClick
    }), slots.default && slots.default());
  }
});
...
var CLink = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    }, props.active && { "aria-current": "page" }), props.component === "a" && props.disabled && { "aria-disabled": true, tabIndex: -1 }), (props.component === "a" || props.component === "button") && {
      onClick: handleClick
    }), {
      href: props.href
    }), slots.default && slots.default());
...
var CDropdownMenu = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => h(props.component, __spreadProps(__spreadValues({
      class: [
        "dropdown-menu",
...
var CDropdownToggle = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const triggers = __spreadValues(__spreadValues({}, (props.trigger === "click" || props.trigger.includes("click")) && {
      onClick: () => {
        if (props.disabled) {
          return;
        }
    ...
    return () => props.custom ? slots.default && slots.default().map((slot) => cloneVNode(slot, __spreadValues({
      ref: (el) => {
        togglerRef.value = el;
      }
    }, triggers))) : dropdownVariant === "nav-item" ? h("a", __spreadValues({
      active: props.active,
      class: [
        "nav-link",
        className,
    ...
    }, triggers), { default: () => slots.default && slots.default() }) : h(CButton, __spreadProps(__spreadValues(__spreadValues({
      class: [
        className,
        {
          show: visible.value
      ...
      shape: props.shape,
      size: props.size
    }, triggers), props.component === "button" && { type: "button" }), {
...
var CFormControlValidation = defineComponent({
  ...
  setup(props, { slots }) {
    return () => [
      props.feedback && (props.valid || props.invalid) && h(CFormFeedback, __spreadProps(__spreadValues({}, props.invalid && { id: props.describedby }), {
...
var CFormCheck = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    const inputClassName = props.button ? "btn-check" : [
      "form-check-input",
      {
        "is-invalid": props.invalid,
        "is-valid": props.valid,
    ...
    const formControl = () => {
      return h("input", __spreadProps(__spreadValues(__spreadValues({}, attrs), props.modelValue && { checked: props.modelValue }), {
    ...
    const formLabel = () => props.button ? h(CButton, __spreadValues(__spreadValues({
      component: "label"
    }, props.button), props.id && { for: props.id }), {
      default: () => slots.label && slots.label() || props.label
    }) : h(CFormLabel, __spreadValues({ class: "form-check-label" }, props.id && { for: props.id }), {
      default: () => slots.label && slots.label() || props.label
    });
    ...
    return () => props.button ? [formControl(), (slots.label || props.label) && formLabel(), formValidation()] : props.label ? props.hitArea ? [
      h(CFormLabel, __spreadValues({
        customClassName: className
      }, props.id && { for: props.id }), [formControl(), props.label]),
      formValidation()
    ] : h("div", {
      class: className
...
var CFormControlWrapper = defineComponent({
  ...
  inheritAttrs: false,
  props: __spreadProps(__spreadValues({}, CFormControlValidation.props), {
    floatingLabel: {
      type: String
    },
    id: {
  ...
  setup(props, { slots }) {
    return () => props.floatingLabel ? h(CFormFloating, [
      ...
      h(CFormControlValidation, {
        ...
        tooltipFeedback: props.tooltipFeedback,
        valid: props.valid
      }, __spreadValues(__spreadValues(__spreadValues({}, slots.feedback && { feedback: () => slots.feedback && slots.feedback() }), slots.feedbackInvalid && {
...
var CFormInput = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    return () => h(CFormControlWrapper, {
      ...
      default: () => h("input", __spreadValues(__spreadProps(__spreadValues({}, attrs), {
        class: [
        ...
        type: props.type
      }), props.modelValue && { value: props.modelValue }), slots.default && slots.default())
    }, slots.feedback && { feedback: () => slots.feedback && slots.feedback() }), slots.feedbackInvalid && {
      feedbackInvalid: () => slots.feedbackInvalid && slots.feedbackInvalid()
    }), slots.feedbackValid && {
      feedbackValid: () => slots.feedbackInvalid && slots.feedbackInvalid()
    }), slots.label && { label: () => slots.label && slots.label() }), slots.text && { text: () => slots.text && slots.text() }));
  }
});
var CFormRange = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    return () => [
      ...
      h("input", __spreadProps(__spreadValues({}, attrs), {
        class: "form-range",
        disabled: props.disabled,
        max: props.max,
        min: props.min,
...
var CFormSelect = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    return () => h(CFormControlWrapper, {
      ...
      default: () => h("select", __spreadValues(__spreadProps(__spreadValues({}, attrs), {
        class: [
          "form-select",
          {
        ...
        onChange: (event) => handleChange(event),
        size: props.htmlSize
      }), props.modelValue && !props.multiple && { value: props.modelValue }), props.options ? props.options.map((option) => {
        return h("option", __spreadValues({}, typeof option === "object" && __spreadValues(__spreadValues(__spreadValues({}, option.disabled && { disabled: option.disabled }), option.selected && { selected: option.selected }), option.value && __spreadValues({
          value: option.value
        }, props.modelValue && props.multiple && props.modelValue.includes(option.value) && { selected: true }))), typeof option === "string" ? option : option.label);
      }) : slots.default && slots.default())
    }, slots.feedback && { feedback: () => slots.feedback && slots.feedback() }), slots.feedbackInvalid && {
      feedbackInvalid: () => slots.feedbackInvalid && slots.feedbackInvalid()
    }), slots.feedbackValid && {
...
var CFormSwitch = defineComponent({
  ...
  setup(props, { attrs, emit }) {
    ...
    return () => h("div", {
      ...
      h("input", __spreadProps(__spreadValues(__spreadValues({}, attrs), props.modelValue && { checked: props.modelValue }), {
        class: [
          "form-check-input",
          {
            "is-invalid": props.invalid,
      ...
      props.label && h(CFormLabel, __spreadProps(__spreadValues({}, props.id && { for: props.id }), {
...
var CFormTextarea = defineComponent({
  ...
  setup(props, { attrs, emit, slots }) {
    ...
    return () => h(CFormControlWrapper, {
      ...
      default: () => h("textarea", __spreadValues(__spreadProps(__spreadValues({}, attrs), {
        disabled: props.disabled,
        readonly: props.readonly,
        class: [
          props.plainText ? "form-control-plaintext" : "form-control",
...
var CListGroupItem = defineComponent({
  ...
  setup(props, { slots }) {
    return () => h(props.component, __spreadValues(__spreadValues(__spreadValues({
      class: [
        "list-group-item",
        {
      ...
      active: props.active,
      disabled: props.disabled
    }), props.active && { "aria-current": true }), props.disabled && { "aria-disabled": true }), slots.default && slots.default());
  }
});
...
var CNavItem = defineComponent({
  name: "CNavItem",
  props: __spreadValues({}, CNavLink.props),
  setup(props, { slots }) {
    return () => h("li", {
      class: "nav-item"
...
var CPaginationItem = defineComponent({
  ...
  setup(props, { slots }) {
    return () => {
      ...
      }, props.active && { active: props.active, "aria-current": "page" }), component === "a" ? h(CLink, {
        class: ["page-link"],
        component,
        href: props.href
      }, {
...
var CProgress = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    }, (props.height, { style: `height: ${props.height}px` })), props.value ? h(CProgressBar, {
      value: props.value,
...
var CToastClose = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    }, () => slots.default && slots.default()) : h(CCloseButton, __spreadProps(__spreadValues({}, props), {
      onClick: () => {
        handleClose();
      }
    }));
...
var h2 = (e) => a.call(e) === "[object Function]";
...
function j(e, t2) {
  const r2 = Object.defineProperties(t2, { _vueTypes_name: { value: e, writable: true }, isRequired: { get() {
    ...
    return e2 === void 0 ? (p(this, "default") && delete this.default, this) : h2(e2) || m(this, e2, true) === true ? (this.default = v(e2) ? () => [...e2] : c(e2) ? () => Object.assign({}, e2) : e2, this) : (d(`${this._vueTypes_name} - invalid default value: "${e2}"`), this);
  } } }), { validator: n2 } = r2;
...
function L(e) {
  ...
  for (let n3 = 0; n3 < e.length; n3 += 1) {
    ...
    if (g(i2)) {
      ...
      if (h2(i2.validator) && (t2 = true), i2.type === true || !i2.type) {
...
var CWidgetStatsB = defineComponent({
  ...
  setup(props, { slots }) {
    return () => h(CCard, {
      ...
      h(CProgress, __spreadProps(__spreadValues(__spreadProps(__spreadValues({
        class: "my-2"
...
// dep:@coreui_vue
var coreui_vue_default = CoreuiVue;
export {
  CAccordion,
  CAccordionBody,
  CAccordionButton,
